<script setup>
import { reactive, onBeforeMount, onMounted, computed, ref } from "vue";
...
onBeforeMount(() => (document.title = "Editar Produto"));
...
const fetchProduct = async () => {
  ...
  try {
    ...
    state.data.category_id = response.data.data.category.id;
  } catch (error) {
...
const handlerUpdate = async () => {
  ...
  try {
    ...
    await http.post("/products/" + props.id, formData, {
      headers: {
